...
export function LedgerTemplate({ data }: AppProps) {
  ...
  return (
    <div
      className={`${styles.root} ${inter.variable} ${spaceGrotesk.variable} ${jetBrainsMono.variable} @container min-w-0 font-sans selection:bg-blue-600/30 selection:text-white overflow-x-hidden`}
    >
      ...
      <main className="max-w-6xl mx-auto px-4 @sm:px-6 @lg:px-8 py-8 @md:py-16 space-y-24 @sm:space-y-32">
        ...
        <section id="hero" className="relative pt-4 @md:pt-12">
          <div className="grid grid-cols-1 @md:grid-cols-12 gap-8 @md:gap-12 items-center">
            ...
            <div className="@md:col-span-7 space-y-6 order-2 @md:order-1 text-center @md:text-left">
              ...
              <h1 id="hero-title" className="break-words text-3xl @sm:text-5xl @lg:text-6xl font-display font-extrabold text-white tracking-tighter uppercase leading-none">
                {portfolio.title}
              </h1>
        ...
        {skills.length > 0 && (
          <section id="skills" className="space-y-8 scroll-mt-20">
            ...
            {/* Skills list layout */}
            <div id="skills-container" className="grid grid-cols-1 @sm:grid-cols-2 @md:grid-cols-3 @lg:grid-cols-4 gap-4">
              <AnimatePresence mode="popLayout">
                    ...
                    >
                      <div className="flex min-w-0 items-start @sm:items-center gap-3 @sm:gap-4">
                        ...
                        <div className="min-w-0">
                          <h4 className="break-words font-mono font-bold text-white text-sm @sm:text-base uppercase tracking-wide">{cert.name}</h4>
